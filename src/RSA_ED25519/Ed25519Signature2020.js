...
export class Ed25519Signature2020 extends LinkedDataSignature {
    ...
    async createVerifyData({document, proof, documentLoader, expansionMap}) {
        ...
        this.canonizeProof(
            ...
            .then(c14nProofOptions => console.log(c14nProofOptions));
    ...
    async assertVerificationMethod({ verificationMethod }) {
        console.log('assertVerificationMethod', verificationMethod)
        let contextUrl;
    ...
    async getVerificationMethod({ proof, documentLoader }) {
        ...
        console.log('getVerificationMethod document', document)

        verificationMethod = typeof document === 'string' ?
            JSON.parse(document) : document;

        console.log('getVerificationMethod verificationMethod', verificationMethod)
